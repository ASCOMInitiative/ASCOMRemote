...
namespace ASCOM.Remote
{
    ...
    public class RotatorBaseClass : ReferenceCountedObjectBase, IRotatorV2
    {
        ...
        public bool CanReverse
        {
            ...
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                return WebClientDriver.GetValue<bool>(clientNumber, client, URIBase, TL, "CanReverse");
            }
        }
        ...
        public float Position
        {
            ...
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                return WebClientDriver.GetValue<float>(clientNumber, client, URIBase, TL, "Position");
            }
        }
        ...
        public bool Reverse
        {
            ...
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                return WebClientDriver.GetValue<bool>(clientNumber, client, URIBase, TL, "Reverse");
            }

            set
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                WebClientDriver.SetBool(clientNumber, client, URIBase, TL, "Reverse", value);
            }
        }
        ...
        public float StepSize
        {
            ...
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                return WebClientDriver.GetValue<float>(clientNumber, client, URIBase, TL, "StepSize");
            }
        }
        ...
        public float TargetPosition
        {
            ...
            {
                WebClientDriver.SetClientTimeout(client, standardServerResponseTimeout);
                return WebClientDriver.GetValue<float>(clientNumber, client, URIBase, TL, "TargetPosition");
            }
        }
        ...
        public void MoveAbsolute(float Position)
        {
            ...
            WebClientDriver.SendToRemoteDriver<NoReturnValue>(clientNumber, client, URIBase, TL, "MoveAbsolute", Parameters, Method.PUT);
