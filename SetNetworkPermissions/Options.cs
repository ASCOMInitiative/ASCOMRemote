...
namespace ASCOM.Remote
{
    ...
    class Options
    {
        [Option('l', SharedConstants.SET_LOCAL_SERVER_PATH_COMMAND_NAME, Required = false, Default = Program.NOT_PRESENT_FLAG, HelpText = "Path to the local server executable")]
        ...
        [Option('h', SharedConstants.USER_NAME_COMMAND_NAME, Required = false, Default = Program.NOT_PRESENT_FLAG, HelpText = "Set the user name for which the HTTP.SYS permission will be enabled")]
